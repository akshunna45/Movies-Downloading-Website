...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('V_S4','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: V_S4.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Vikings Season 4 COMPLETE BluRay 720p Free Download</font></p>
				  </div>
		...
		<p align="center">
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/G3DwTh_aPKw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</p>
		<p align="center"> 
			 <b>Language: </b>Hindi + English<br> 
			 <b>Quality: </b>720p BluRay<br>
			 <b>Size: </b>200MB TO 300MB Per Episode<br> 
...
<div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  title="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  src="https://i.imgur.com/4sAaLDa.jpg" 
				  alt="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  border="0" height="350" width="600"><br>
			 <img class="alignnone" 
				  title="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  src="https://i.imgur.com/nIxTBLi.png" 
				  alt="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  border="0" height="350" width="600"><br>
			 <img class="alignnone" 
				  title="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  src="https://i.imgur.com/rM0NGvj.jpg" 
				  alt="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  border="0" height="350" width="600"><br>
		     <img class="alignnone" 
				  title="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  src="https://i.imgur.com/C35DGQx.jpg" 
				  alt="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  border="0" height="350" width="600">
	    </div>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/21011/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="V_S5.php">
						<span class="movies">Vikings Season 5 (2018) Complete720p Download WEB-DL (S05E20) – Episode 20 Added</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="V_S4.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='V_S4' ORDER BY datetime DESC";
