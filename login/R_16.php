...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('R_16','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: R_16.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Remo 2016 Full Movie 720p Tamil HDRip With ESubs  Free Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/tamil24.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
           ...
           <b>Genres</b> : 
			  ...
			  <a rel="tag">Romance</a>
		   <br>			   
		   <b>Runtime</b> : 02h 51m 00s<br>
		   <b>Release&nbsp;Date</b> 07&nbsp;October&nbsp;2016<br>
		   <b>Cast</b> : 
			  <a rel="tag">Aadukalam Naren</a>, 
			  <a rel="tag"> Kalyani N.</a>,
			  <a rel="tag">Siva Karthikeyan</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		   <iframe width="700" height="400" src="https://www.youtube.com/embed/GEB4qrrWIgs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
        ...
        <div class="separator" style="clear: both; text-align: center;">
			 <img class="alignnone" 
				  title="Remo 2016 Full Movie 720p Tamil HDRip With ESubs  Free Download" 
				  src="https://extraimage.net/images/2018/09/30/b2d0507f6cf248526c4bd5bebbf3634f.jpg" 
				  alt="Remo 2016 Full Movie 720p Tamil HDRip With ESubs  Free Download" 
				  border="0">
	    </div>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">
		   ...
		   <br>
			<b></b>
		       <a href="https://hubfiles.ws/b638469edab02167" target="_blank">Hubfiles</a>
		   <br>
			<b></b>
		       <a href="https://server7.kproxy.com/servlet/redirect.srv/sxc/sanvtroiw/p2/b638469edab02167" target="_blank">Hubfiles With VPN</a>
		   <br>
        </p>
...
<br/>
<form action="R_16.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='R_16' ORDER BY datetime DESC";
