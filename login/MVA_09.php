...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('MVA_09','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: MVA_09.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Monsters vs. Aliens (2009) Dual Audio [Hindi-DD5.1] 720p BluRay ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/animated15.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <b>Genres</b> : 
			  ...
			  <a rel="tag">Action</a>
		   <br>			
		   <b>Runtime</b> : 1h 42m <br>
		   <b>Release&nbsp;Date</b> : 02&nbsp;April&nbsp;2009<br>		<b>Cast</b> : 
			  <a rel="tag">Reese Witherspoon</a>, 
			  <a rel="tag">Rainn Wilson</a>,
			  <a rel="tag">Stephen Colbert</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/76XkslTbkjU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  ...
				  src="https://4.bp.blogspot.com/-VP3cmss8hp4/VrmYK6yXy4I/AAAAAAAAFmM/OxuWB5Oizuw/s1600/Monsters%2Bvs%2BAliens%2B2009%2BDual%2BAudio%2BHindi%2B480p%2BBluRay.jpg" 
	    ...
	    <div class="movies-heading text-center">
	     ...
	     <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/9cg55cpsmjdc" target="_blank">Indishare</a>
		   <br>
        </p>	
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="WP_19.php">
						<span class="movies">White Fang (2018) Dual Audio [Hindi-DD5.1] 720p BluRay ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="MVA_09.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='MVA_09' ORDER BY datetime DESC";
