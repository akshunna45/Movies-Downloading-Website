...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('JWC2_17','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: JWC2_17.php");
	}
	else
	{
...
<body>
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;John Wick: Chapter 2 (2017) Dual Audio [Hindi-English] 720p BluRay ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/holly20.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <br>			
		   <b>Runtime</b> : 02h 02m 22s<br>
		   <b>Release&nbsp;Date</b> : 16&nbsp;Februrary&nbsp;2016<br>		<b>Cast</b> : 
			  <a rel="tag">Riccardo Scamarcio</a>, 
			  <a rel="tag">Ian McShane</a>,
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/XGk2EfbD_Ps" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
		...
		<img class="alignnone" 
			...
			src="https://extraimage.net/images/2018/03/10/c43e97a33addf7176c7870a20b41f537.jpg" 
 ...
 <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/5ybuntiefdxi" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="JWC3_19.php">
						<span class="movies">John Wick: Chapter 3 Parabellum (2019) Full Movie [English-DD5.1] 720p BluRay ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="JWC2_17.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='JWC2_17' ORDER BY datetime DESC";
