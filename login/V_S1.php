...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('V_S1','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: V_S1.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Vikings Season 1 Hindi Dubbed Web Series All Episodes 720p Free Download</font></p>
				  </div>
		...
		<p align="center">
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/f5av6OqFwz0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  ...
				  src="https://extraimage.net/images/2018/07/23/d7190bde4c3b3b3123689d60df9b8f9c.jpg" 
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/20165/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="V_S2.php">
						<span class="movies">Vikings Season 2 Hindi Dubbed Web Series All Episodes 720p Free Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="V_S1.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='V_S1' ORDER BY datetime DESC";
