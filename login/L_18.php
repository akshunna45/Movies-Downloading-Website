...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('L_18','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: L_18.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Lupt (2019) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/bolly8.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <b>Genres</b> : 
			  ...
			  <a rel="tag">Drama</a>
		   <br>			
		   <b>Runtime</b> : 01h 49m 35s<br>
		   <b>Release&nbsp;Date</b> : 02&nbsp;November&nbsp;2019<br>		<b>Cast</b> : 
			  <a rel="tag"> Javed Jaffrey</a>,
			  <a rel="tag">Karan Aanand</a>,
			  <a rel="tag">Vijay Raaz</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/FxhUuHzULcM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
    <img class="alignnone" title="Lupt (2019) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download" 
	     src="https://imgshare.info/images/2019/04/04/Lupt-2018-Hindi-www.downloadhub.biz-720p-HDRip-ESubs_s.jpg" 
		 alt="Lupt (2019) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download" 
    ...
    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/u7cxgnarbsf5" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="MZ_16.php">
						<span class="movies">Mastizaade (2016) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="L_18.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='L_18' ORDER BY datetime DESC";
