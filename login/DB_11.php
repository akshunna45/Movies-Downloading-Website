...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('DB_11','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: DB_11.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Desi Boyz (2011) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/bolly7.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <b>Genres</b> : 
			  ...
			  <a rel="tag">Drama</a>
		   <br>			
		   <b>Runtime</b> : 02h 01m 39s<br>
		   <b>Release&nbsp;Date</b> : 25&nbsp;November&nbsp;2011<br>		<b>Cast</b> : 
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/wOcisXA4z4Y" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
    <img class="alignnone" title="Desi Boyz (2011) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download" 
	     src="https://i.imgur.com/c1RezqB.jpg" 
		 alt="Desi Boyz (2011) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download" 
    ...
    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/mu2mop5uvytq" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="L_18.php">
						<span class="movies">Lupt (2018) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="DB_11.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='DB_11' ORDER BY datetime DESC";
