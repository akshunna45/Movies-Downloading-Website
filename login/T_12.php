...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('T_12','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: T_12.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Thuppakki (2012) 720p Tamil BRRip Dual Audio Full Movie</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/tamil22.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
           ...
           <b>Genres</b> : 
			  ...
			  <a rel="tag">Crime</a>
		   <br>			   
		   <b>Runtime</b> : 02h 45m 00s<br>
		   <b>Release&nbsp;Date</b> 13&nbsp;November&nbsp;2012<br>
		   <b>Cast</b> : 
			  <a rel="tag"> Kajal Aggarwal</a>, 
			  <a rel="tag">Sathyan</a>,
			  <a rel="tag">Vidyut Jamwal</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		   <iframe width="700" height="400" src="https://www.youtube.com/embed/s0O44Sn1hD4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
        ...
        <div class="separator" style="clear: both; text-align: center;">
			 <img class="alignnone" 
				  title="Thuppakki (2012) 720p Tamil BRRip Dual Audio Full Movie" 
				  src="https://4.bp.blogspot.com/-FlT7IIRM6dg/VqHCL1OfDgI/AAAAAAAAJZw/QhLvT7oyxp0/s1600/MBT212720HBRRDAFMD.mkv.jpg" 
				  alt="Thuppakki (2012) 720p Tamil BRRip Dual Audio Full Movie" 
				  border="0">
	    </div>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="http://www.indishare.org/7akw75ihc7bg" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="IM_16.php">
						<span class="movies">Iru Mugan (2016) 720p Tamil HDRip Full Movie Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="T_12.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='T_12' ORDER BY datetime DESC";
