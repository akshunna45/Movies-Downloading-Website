...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('DHRUVA_16','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: DHRUVA_16.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Dhruva 2016 Hindi Dubbed 720p HDRip Full Movie x264 Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/tamil19.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <br>			   
		   <b>Runtime</b> : 02h 45m 34s<br>
		   <b>Release&nbsp;Date</b> 09&nbsp;December&nbsp;2016<br>
		   <b>Cast</b> : 
			  <a rel="tag">Arvind Swamy</a>, 
			  <a rel="tag">Farah Karimaee</a>,
			  <a rel="tag">Nassar</a>
		   <br>
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/r_yVN37aCYI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
        ...
        <div class="separator" style="clear: both; text-align: center;">
			 <img class="alignnone" 
				  title="Dhruva 2016 Hindi Dubbed 720p HDRip Full Movie x264 Download" 
				  src="https://extraimage.net/images/2019/05/05/a8770f1a2559a4d90dde0a95904f67e5.jpg" 
				  alt="Dhruva 2016 Hindi Dubbed 720p HDRip Full Movie x264 Download" 
				  border="0">
	    </div>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">	
		   <b></b>
		       <a href="https://www.indishare.org/w921napctzxy" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="D_15.php">
						<span class="movies">Dynamite (2015) Hindi Dubbed ORG 720p HDRip 1.4GB Full Movie Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="DHRUVA_16.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='DHRUVA_16' ORDER BY datetime DESC";
