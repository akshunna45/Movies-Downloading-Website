...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('JWC3_19','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: JWC3_19.php");
	}
	else
	{
...
<body>
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;John Wick: Chapter 3 Parabellum (2019) Full Movie [English-DD5.1] 720p BluRay ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/holly21.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <br>			
		   <b>Runtime</b> : 02h 11m 05s<br>
		   <b>Release&nbsp;Date</b> : 23&nbsp;May&nbsp;2019<br>		<b>Cast</b> : 
			  <a rel="tag"> Halle Berry</a>, 
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/M7XM597XO94" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
		...
		<img class="alignnone" 
			...
			src="https://extraimage.net/images/2019/08/18/2f75c8944868d56993be4b04b0c1ce18.jpg" 
   ...
   <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/kgjz49i0tp7f" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="JWC3_19.php">
						<span class="movies">Creed (2015) Dual Audio [Hindi-English] 720p BluRay ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="JWC3_19.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='JWC3_19' ORDER BY datetime DESC";
