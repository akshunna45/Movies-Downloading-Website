...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('GOT_S8','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: GOT_S8.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Game of Thrones S08 Complete Hindi Dubbed 720p HDRip [Ep 03 Added]</font></p>
				  </div>
		...
		<p align="center">
		   <b>IMDB&nbsp;Rating</b> : 9.5/10<br>
		   <b>Genres</b> : 
			  <a rel="tag">Action</a>,
			  <a rel="tag">Adventure</a>,
			  <a rel="tag">Drama</a>
		   <br>			
		   <b>Release&nbsp;Date</b> :15&nbsp;July&nbsp;2016<br>			
		   <b>Cast</b> : 
			  <a rel="tag">Peter Dinklage</a>, 
			  <a rel="tag">Nikolaj Coster-Waldau</a>,
			  <a rel="tag">Lena Headey</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/rlR4PJn8b8I" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
			 <b>Language: </b>Hindi + English<br> 
			 <b>Quality: </b>720p BluRay<br>
			 <b>Size: </b>170MB TO 400MB Per Episode<br> 
...
<div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  title="Game of Thrones S08 Complete Hindi Dubbed 720p HDRip [Ep 03 Added]" 
				  src="https://extraimage.net/images/2019/05/07/8cd28ed64a7f42582657e27d1667afd0.jpg" 
				  alt="Game of Thrones S08 Complete Hindi Dubbed 720p HDRip [Ep 03 Added]" 
				  border="0">
	    </div>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/16682/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="ITB_S1.php">
						<span class="movies">Into The Badlands Season 1 Hindi Dubbed WEB Series All Episodes Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="GOT_S8.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='GOT_S8' ORDER BY datetime DESC";
