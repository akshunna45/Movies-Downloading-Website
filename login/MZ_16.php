...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('MZ_16','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: MZ_16.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Mastizaade (2016) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/bolly9.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   <b>IMDB&nbsp;Rating</b> : 2.4/10<br>
		   <b>Genres</b> : 
			  <a rel="tag">Comedy</a>
			  <a rel="tag">Drama</a>
		   <br>			
		   <b>Runtime</b> : 01h 45m 57s<br>
		   <b>Release&nbsp;Date</b> : 29&nbsp;January&nbsp;2016<br>		<b>Cast</b> : 
			  <a rel="tag"> Ishita Chauhan</a>,
			  <a rel="tag">Mona Ambegaonkar</a>,
			  <a rel="tag">Shiney Ahuja</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/pIVQU9vjK28" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
    <img class="alignnone" title="Mastizaade (2016) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download" 
	     src="https://i.imgur.com/yyQoVNM.jpg" 
		 alt="Mastizaade (2016) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download" 
    ...
    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/lngs9gg7blbj" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="N_16.php">
						<span class="movies">Neerja (2016) Hindi 720p BRRip Full Movie Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="MZ_16.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='MZ_16' ORDER BY datetime DESC";
