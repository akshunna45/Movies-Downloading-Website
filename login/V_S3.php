...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('V_S3','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: V_S3.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Vikings Season 3 Web Series All Episodes 720p Free Download</font></p>
				  </div>
		...
		<p align="center">
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/UQm9torR1K8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</p>
		<p align="center"> 
			 <b>Language: </b>English<br> 
			 <b>Quality: </b>720p BluRay<br>
			 <b>Size: </b>150MB TO 200MB Per Episode<br> 
...
<div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  ...
				  src="https://i.imgur.com/jDm4J8i.jpg" 
				  alt="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  border="0" height="350" width="600"><br>
			 <img class="alignnone" 
				  title="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  src="https://i.imgur.com/uDNb96q.jpg" 
				  alt="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  border="0" height="350" width="600"><br>
			 <img class="alignnone" 
				  title="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  src="https://i.imgur.com/Dqyv7et.jpg" 
				  alt="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  border="0" height="350" width="600"><br>
		     <img class="alignnone" 
				  title="Game of Thrones S02 Complete English 720p BRRip free Download" 
				  src="https://i.imgur.com/ziQh9jm.jpg" 
				  alt="Game of Thrones S02 Complete English 720p BRRip free Download" 
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/21009/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="V_S4.php">
						<span class="movies">Vikings Season 4 Web Series All Episodes 720p Free Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="V_S3.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='V_S3' ORDER BY datetime DESC";
