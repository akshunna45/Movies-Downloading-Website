...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('TZP_07','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: TZP_07.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Taare Zameen Par (2007) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/bolly4.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <br>			
		   <b>Runtime</b> : 02h 42m 32s<br>
		   <b>Release&nbsp;Date</b> : 21&nbsp;December&nbsp;2017<br>		<b>Cast</b> : 
			  <a rel="tag">Aamir Khan</a>,
			  <a rel="tag">Darsheel Safary</a>,
			  <a rel="tag">Tisca Chopra</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/tn_2Ie_jtX8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
    <img class="alignnone" title="Taare Zameen Par (2007) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download" 
	     src="https://i.imgur.com/5UGE9aJ.jpg" 
		 alt="Taare Zameen Par (2007) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download" 
    ...
    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/azzdz0dcb9o0" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="TAPM_19.php">
						<span class="movies">The Accidental Prime Minister (2019) Full Movie Hindi 720p HDRip ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="TZP_07.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='TZP_07' ORDER BY datetime DESC";
