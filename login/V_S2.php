...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('V_S2','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: V_S2.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Vikings Season 2 Hindi Dubbed Web Series All Episodes 720p Free Download</font></p>
				  </div>
		...
		<p align="center">
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/fXOej9DUHJ4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  ...
				  src="https://imgshare.info/images/2018/10/28/Vikings-S02E01-EXTENDED-BluRay-720p-Dual-Audio-Hindi_s.jpg" 
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/20245/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="V_S3.php">
						<span class="movies">Vikings Season 3 Web Series All Episodes 720p Free Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="V_S2.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='V_S2' ORDER BY datetime DESC";
