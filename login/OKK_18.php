...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('OKK_18','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: OKK_18.php");
	}
	else
	{
...
<body>
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Oru Kuppai Kathai (2018) Tamil Movie 720p HDRip 800MB ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/tamil6.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
           ...
           <b>Genres</b> : 
			  ...
			  <a rel="tag">Drama</a>			
		   <br>			   
		   <b>Runtime</b> : 02h 15m 30s<br>
		   <b>Release&nbsp;Date</b> 25&nbsp;May&nbsp;2018<br>
		   <b>Cast</b> : 
			  <a rel="tag">Dinesh</a>, 
			  <a rel="tag">‎ Manisha Yadav</a>,
			  <a rel="tag">Sujo Mathew</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		<iframe width="700" height="400" src="https://www.youtube.com/embed/_GCvp1cLpxI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
    ...
    <div class="separator" style="clear: both; text-align: center;"> 
		<img class="alignnone" 
		title="Oru Kuppai Kathai (2018) Tamil Movie 720p HDRip 800MB ESubs Download" 
		src="https://extraimage.net/images/2019/08/22/6439239e5b981e5f93909d31e417648a.jpg" 
		alt="Oru Kuppai Kathai (2018) Tamil Movie 720p HDRip 800MB ESubs Download" 
		border="0"> <br> 
	</div>
	<div class="movies-heading text-center">
	    ...
	    <p align="center">
		   ...
		   <br>	
		   <b></b>
		       <a href="https://zupload.me/0b3cf811f9f6d2cb" target="_blank">Zupload</a>
		   <br>	
		   <b></b>
		       <a href="https://server9.kproxy.com/servlet/redirect.srv/sjs/sljywbhn/p2/0b3cf811f9f6d2cb" target="_blank">Zupload With VPN</a>
		   <br>
        </p>
...
<br/>
<form action="OKK_18.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='OKK_18' ORDER BY datetime DESC";
