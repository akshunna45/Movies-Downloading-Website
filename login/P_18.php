...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('P_18','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: P_18.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Paadam (2018) Tamil 720p WEB-DL 1.2GB Free Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/tamil8.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   <b>IMDB&nbsp;Rating</b> : 5.1/10<br>	
           <b>Genres</b> : 
			  <a rel="tag">Drama</a>
		   <br>			   
		   <b>Runtime</b> : 02h 06m 00s<br>
		   <b>Release&nbsp;Date</b> 20&nbsp;April&nbsp;2018<br>
		   <b>Cast</b> : 
			  <a rel="tag">Yashika Aannand</a>, 
			  <a rel="tag">‎Karthik</a>,
			  <a rel="tag">Vijith</a>
		   <br>
		   ...
		   <p align="center">
		<iframe width="700" height="400" src="https://www.youtube.com/embed/zhH06QQwfKA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
        ...
        <div class="separator" style="clear: both; text-align: center;">
			 <img class="alignnone" 
				  title="Paadam (2018) Tamil 720p WEB-DL 1.2GB Free Download" 
				  src="https://extraimage.net/images/2019/08/19/8dabda26cb0696af571c78a9a09b927a.jpg" 
				  alt="Paadam (2018) Tamil 720p WEB-DL 1.2GB Free Download"
                  border="0">
              </div>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://dl1.indishare.in/murzo6l44k0w" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="MEI_19.php">
						<span class="movies">MEI (2019) Tamil 720p DVDScr 1GB | 400MB Full Movie Download </span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="P_18.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='P_18' ORDER BY datetime DESC";
