...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('S_18','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: S_18.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Sarkar (2018) Tamil 720p WEB-DL 1.1GB ESubs Free Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/tamil21.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
           ...
           <b>Genres</b> : 
			  ...
			  <a rel="tag">Drama</a>
		   <br>			   
		   <b>Runtime</b> : 02h 44m 03s<br>
		   <b>Release&nbsp;Date</b> 06&nbsp;November&nbsp;2018<br>
		   <b>Cast</b> : 
			  <a rel="tag">Joseph Vijay</a>, 
			  <a rel="tag"> Keerthi Suresh</a>,
			  <a rel="tag"> A.R. Murugadoss</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/VkkyaodksT4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
			 ...
			 <b>Subtitle: </b>Tamil<br>
        <div class="movies-heading text-center">
			 <h3>ScreenShots</h3>
		</div>
        <div class="separator" style="clear: both; text-align: center;">
			 <img class="alignnone" 
				  title="Sarkar (2018) Tamil 720p WEB-DL 1.1GB ESubs Free Download" 
				  src="https://imgshare.info/images/2019/05/20/b5b37eb3956eca94a8b5cd7f6d3c4246.jpg" 
				  alt="Sarkar (2018) Tamil 720p WEB-DL 1.1GB ESubs Free Download" 
				  border="0">
	    </div>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://clicknupload.org/1b36b4kithjy" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="T_12.php">
						<span class="movies">Thuppakki (2012) 720p Tamil BRRip Dual Audio Full Movie</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="S_18.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='S_18' ORDER BY datetime DESC";
