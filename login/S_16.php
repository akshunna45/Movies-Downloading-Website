...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('S_16','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: S_16.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Sarbjit (2016) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/bolly2.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <br>			
		   <b>Runtime</b> : 02h 11m 56s<br>
		   <b>Release&nbsp;Date</b> : 26&nbsp;May&nbsp;2016<br>		<b>Cast</b> : 
			  <a rel="tag">Aishwarya Rai Bachchan</a>,
			  <a rel="tag">Randeep Hooda</a>,
			  <a rel="tag">Richa Chadha</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/q1kYpWU7apI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
    <img class="alignnone" title="Sarbjit (2016) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download" 
	     src="https://i.imgur.com/2Yusogy.jpg" 
		 alt="Sarbjit (2016) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download" 
    ...
    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/583ulj0nlf76" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="706_19.php">
						<span class="movies">706 (2019) Full Movie [Hindi-DD5.1] 720p HDRip ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="S_16.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='S_16' ORDER BY datetime DESC";
