...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('ITB_S1','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: ITB_S1.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Into The Badlands S01 Dual Audio Hindi Complete 720p BRRip 2.6GB Free Download</font></p>
				  </div>
		...
		<p align="center">
		   <b>IMDB&nbsp;Rating</b> : 8.8/10<br>
		   <b>Genres</b> : 
			  <a rel="tag">Action</a>,
			  <a rel="tag">Adventure</a>,
			  <a rel="tag">Drama</a>
		   <br>			
		   <b>Number Of Episodes</b> : 6 Episodes<br>
		   <b>Release&nbsp;Date</b> : 15&nbsp;November&nbsp;2015<br>		<b>Cast</b> : 
		   ...
		   <p align="center">
		   <iframe width="700" height="400" src="https://www.youtube.com/embed/ZF-SOC49ofw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
			 <b>Language: </b>Hindi + English<br> 
			 <b>Quality: </b>720p BRRip<br>
			 <b>Size: </b>2.6GB<br> 
        ...
        <div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  title="Into The Badlands S01 Dual Audio Hindi Complete 720p BRRip 2.6GB Free Download" 
				  src="https://imgshare.info/images/2019/07/16/909d89851f95faa5bbdaa1ffb31fb777.jpg" 
				  alt="Into The Badlands S01 Dual Audio Hindi Complete 720p BRRip 2.6GB Free Download" 
				  border="0">
        </div>
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/10827/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="ITB_S2.php">
						<span class="movies">Into The Badlands Season 2 Hindi Dubbed WEB Series All Episodes Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="ITB_S1.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='ITB_S1' ORDER BY datetime DESC";
