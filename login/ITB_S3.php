...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('ITB_S3','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: ITB_S3.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Into The Badlands Season 3 Hindi Dubbed WEB Series All Episodes Download</font></p>
				  </div>
		...
		<p align="center">
		   ...
		   <p align="center">
		   <iframe width="700" height="400" src="https://www.youtube.com/embed/-Jtys3lxu-w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
...
<p align="center">
   <img src="https://www.imgshare.info/images/2018/12/06/Intothe.Badlands.S03.E01.Downloadhub.link_s.jpg" 
   alt="Into The Badlands S03 Complete Dual Audio Hindi 720p WEB-DL Download" 
   title="Into The Badlands S03 Complete Dual Audio Hindi 720p WEB-DL Download">
</p>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/10844/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="WA_S1.php">
						<span class="movies">Wu Assassins Season 1 Dual Audio [Hindi-DD5.1] 720p HDRip ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="ITB_S3.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='ITB_S3' ORDER BY datetime DESC";
