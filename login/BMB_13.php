...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('BMB_13','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: BMB_13.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Bhaag Milkha Bhaag (2013) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/bolly6.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   <b>IMDB&nbsp;Rating</b> : 8.2/10<br>
			...
			<a rel="tag">Biography</a>,
			  ...
			  <a rel="tag">History</a>
			<br>
		   <b>Runtime</b> : 03h 06m 24s<br>
		   <b>Release&nbsp;Date</b> : 12&nbsp;July&nbsp;2013<br>		<b>Cast</b> : 
			  <a rel="tag">Farhan Akhtar</a>,
			  <a rel="tag">Pavan Malhotra</a>,
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/u71swQ4ksgI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
    <img class="alignnone" 
	     title="Bhaag Milkha Bhaag (2013) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download" src="https://i.imgur.com/F6O1wxc.jpg" 
		 alt="Bhaag Milkha Bhaag (2013) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download" 
		 border="0"> <br> 
</div>
    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://www.indishare.org/247qbac0nxxk" target="_blank">Indishare</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="DB_11.php">
						<span class="movies">Desi Boyz (2011) Full Movie [Hindi-DD5.1] 720p BluRay ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="BMB_13.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='BMB_13' ORDER BY datetime DESC";
