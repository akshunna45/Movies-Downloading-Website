...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('KK_19','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: KK_19.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Kadaram Kondan 2019 Tamil 720p WEB-DL 850MB ESubs Free Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/tamil13.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   ...
		   <br>			   
		   <b>Runtime</b> : 02h 01m 09s<br>
		   <b>Release&nbsp;Date</b> : 19&nbsp;July&nbsp;2019<br>
		   <b>Cast</b> : 
			  <a rel="tag">Vikram</a>, 
			  <a rel="tag">Akshara Haasan</a>,
			  <a rel="tag">Abi Hassan</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/zqn1IM2DU8A" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
        ...
        <div class="separator" style="clear: both; text-align: center;">
			 <img class="alignnone" 
				  title="Kadaram Kondan (2019) Tamil 720p WEB-DL 850MB ESubs Free Download" 
				  src="https://extraimage.net/images/2019/08/24/c1fb7bfc8b86cb5fb9a7edf9f776cb51.jpg" 
				  alt="Kadaram Kondan (2019) Tamil 720p WEB-DL 850MB ESubs Free Download" 
				  border="0">
	    </div>
	    <div class="movies-heading text-center">
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://9xupload.xyz/f/c1no46-wrhqa2sheuhwa" target="_blank">9xUpload</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="TT_12.php">
						<span class="movies">Thadayara Thakka (2012) 720p Hindi HDRip Full Movie Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="KK_19.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='KK_19' ORDER BY datetime DESC";
