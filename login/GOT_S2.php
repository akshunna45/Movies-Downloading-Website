...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('GOT_S2','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: GOT_S2.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Game of Thrones S02 Complete Hindi Dual Audio 720p BRRip ESubs</font></p>
				  </div>
		...
		<p align="center">
		   ...
		   <b>Genres</b> : 
			  ...
			  <a rel="tag">Drama</a>
		   <br>			
		   <b>Release&nbsp;Date</b> :10&nbsp;April&nbsp;2012<br>			
		   <b>Cast</b> : 
		   ...
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/XuKfFzk1uQs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</p>
		<p align="center"> 
...
<div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  ...
				  src="https://www.imgshare.info/images/2018/09/01/Game-of-Thrones-S02E01-Downloadhub.cc_s.jpg" 
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/17066/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="GOT_S3.php">
						<span class="movies">Game of Thrones Season 3 Complete 720p BluRay With ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="GOT_S2.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='GOT_S2' ORDER BY datetime DESC";
