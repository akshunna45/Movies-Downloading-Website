...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('GOT_S1','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: GOT_S1.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Game of Thrones S01 Complete Dual Audio 720p BRRip [Hindi – English]</font></p>
				  </div>
		...
		<p align="center">
		   ...
		   <b>Genres</b> : 
			  ...
			  <a rel="tag">Drama</a>
		   <br>			
		   <b>Release&nbsp;Date</b> :17&nbsp;April&nbsp;2011<br>			
		   <b>Cast</b> : 
			  <a rel="tag">Emilia Clarke</a>, 
			  <a rel="tag">Peter Dinklage</a>,
			  <a rel="tag">Kit Harington</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		  <iframe width="700" height="400" src="https://www.youtube.com/embed/gcTkNV5Vg1E" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</p>
		<p align="center"> 
			 <b>Language: </b>Hindi + English<br> 
			 <b>Quality: </b>720p BluRay<br>
			 <b>Size: </b>250MG TO 350MB<br> 
...
<div class="separator" style="clear: both; text-align: center;"> 
             <img class="alignnone" 
				  ...
				  src="https://www.imgshare.info/images/2018/06/18/Game-of-Thrones-S01E01-Downloadhub.cc_s.jpg" 
	    ...
	    <p align="center">
			<b></b>
		       <a href="https://healthtipschk.co/16913/" target="_blank">Direct</a>
		   <br>
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="GOT_S2.php">
						<span class="movies">Game of Thrones Season 2 Complete 720p BluRay With ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="GOT_S1.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='GOT_S1' ORDER BY datetime DESC";
