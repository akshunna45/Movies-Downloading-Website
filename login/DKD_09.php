...
if(isset($_POST['submit']))
{
	...
	if($name&&$comment)
	{
		...
		$sql = "INSERT INTO comment" . "(movie_id, name, comment)" . "VALUES ('DKD_09','$name','$comment')";
		mysqli_query($conn, $sql);
		header("location: DKD_09.php");
	}
	else
	{
	...
	<section class="api-map" id="about">
			 <div class="container-fluid">
				  ...
				  <div class="about-heading">							
					   <p><font size="60"> &nbsp; &nbsp;Do Knot Disturb (2009) Full Movie [Hindi-DD5.1] 720p DVDRip ESubs Download</font></p>
				  </div>
				  <div class="col-md-3 col-sm-5">
					   <div class="single-about-detail">
							<div class="about-img">
								 <img src="img/bolly17.jpg" alt="">
							</div>
					   </div>
				  </div>
			 </div>
		...
		<p align="center">
		   <b>IMDB&nbsp;Rating</b> : 3.7/10<br>
		   <b>Genres</b> : 
			  <a rel="tag">Drama</a>
		   <br>			
		   <b>Runtime</b> : 1h 59m 55s<br>
		   <b>Release&nbsp;Date</b> : 02&nbsp;October&nbsp;2009<br>		<b>Cast</b> : 
			  <a rel="tag">Govinda</a>, 
			  <a rel="tag">Riteish Deshmukh</a>,
			  <a rel="tag">Sushmita Sen</a>
		   <br>
		   <div class="movies-heading text-center">
			 <h3>Trailer</h3>
		   </div>	
		   <p align="center">
		   <iframe width="700" height="400" src="https://www.youtube.com/embed/rvH4RmeuOw4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		   </p>	   
		</p>
		<p align="center"> 
			 <b>Language: </b>Hindi DD5.1<br> 
			 <b>Quality: </b>720p DVDRip<br>
			 <b>Size: </b>968MB<br> 
...
<div class="separator" style="clear: both; text-align: center;"> 
    <img class="alignnone" title="Do Knot Disturb (2009) Full Movie [Hindi-DD5.1] 720p DVDRip ESubs Download" 
	     src="https://i.imgur.com/fflgOMP.jpg" 
		 alt="Do Knot Disturb (2009) Full Movie [Hindi-DD5.1] 720p DVDRip ESubs Download" 
		 border="0"> <br> 
    <div class="movies-heading text-center">
	    ...
	    <p align="center">	
		   <b></b>
		       <a href="https://bdupload.asia/n9gd45qwi3uu" target="_blank">bdupload</a>
		   <br>	
        </p>
	<div class="movies" align="left">
		 <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You May Also Like :</h3>
		     <ul>
				 <li>
					 <a href="A_99.php">
						<span class="movies">Aarzoo (1999) Full Movie Hindi 720p HDRip ESubs Download</span>
					 </a>
				 </li>
		     </ul>
	</div>
...
<br/>
<form action="DKD_09.php" method="POST">
<table>
...
<?php
$sql1 = "SELECT * FROM comment WHERE movie_id='DKD_09' ORDER BY datetime DESC";
